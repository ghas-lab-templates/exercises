...
6. Create a pull request to the `main` branch. Wait for the scans to complete and you should see a CodeQL javascript alert in your pull request. Oh no! There is a vulnerability in our sanitization! Luckily we have Copilot Autofix. Review the fix generated by Autofix, and if satisfied with it, accept it. This will retrigger a CodeQL scan and the alert should be resolved.
...
6. Click on the green `Commit to new branch` button.
